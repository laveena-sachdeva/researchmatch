...
@register.simple_tag(name='add_form_widget_attr')
...
@register.simple_tag(name='block_anyfilter')
...
@register.simple_tag(name='calculate_dimensions')
...
@register.simple_tag(name='get_query_params')
